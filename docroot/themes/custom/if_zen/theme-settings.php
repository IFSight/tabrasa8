 ...
 */
function if_zen_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['if_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('if_zen sample setting'),
  '#default_value' => theme_get_setting('if_zen_example'),
