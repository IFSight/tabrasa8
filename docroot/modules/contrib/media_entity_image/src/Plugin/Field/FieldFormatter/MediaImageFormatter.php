...
namespace Drupal\media_entity_image\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'media_image' formatter.
 *
 * @FieldFormatter(
 *   id = "media_image",
 ...
 * )
 */
class MediaImageFormatter extends ImageFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($media as $delta => $media_item) {
      ...
      $source_field_name = $media_item->bundle->entity->type_configuration['source_field'];

      if (isset($link_media)) {
        $url = $media_item->toUrl();
      }
      //kint($media_item->get('thumbnail'));
      $elements[$delta] = [
        '#theme' => 'image_formatter',
        '#item' => $media_item->get($source_field_name),
        '#item_attributes' => [],
